...
func newAgreementVersion(db *gorm.DB, opts ...gen.DOOption) agreementVersion {
	...
	_agreementVersion.ID = field.NewUint64(tableName, "id")
	_agreementVersion.Version = field.NewString(tableName, "version")
	_agreementVersion.Content = field.NewString(tableName, "content")
	_agreementVersion.TermsOfService = field.NewString(tableName, "terms_of_service")
	_agreementVersion.PrivacyPolicy = field.NewString(tableName, "privacy_policy")
	_agreementVersion.SweepsRules = field.NewString(tableName, "sweeps_rules")
	_agreementVersion.CreatedAt = field.NewTime(tableName, "created_at")
	_agreementVersion.UpdatedAt = field.NewTime(tableName, "updated_at")
...
type agreementVersion struct {
	...
	TermsOfService field.String
	PrivacyPolicy  field.String
	SweepsRules    field.String
...
func (a *agreementVersion) updateTableName(table string) *agreementVersion {
	...
	a.TermsOfService = field.NewString(table, "terms_of_service")
	a.PrivacyPolicy = field.NewString(table, "privacy_policy")
	a.SweepsRules = field.NewString(table, "sweeps_rules")
...
func (a *agreementVersion) fillFieldMap() {
	...
	a.fieldMap["terms_of_service"] = a.TermsOfService
	a.fieldMap["privacy_policy"] = a.PrivacyPolicy
	a.fieldMap["sweeps_rules"] = a.SweepsRules
