...
func newAgreement(db *gorm.DB, opts ...gen.DOOption) agreement {
	...
	_agreement.ID = field.NewUint64(tableName, "id")
	_agreement.UserID = field.NewInt32(tableName, "user_id")
	_agreement.Content = field.NewString(tableName, "content")
	_agreement.Version = field.NewString(tableName, "version")
	_agreement.AgreedAt = field.NewInt64(tableName, "agreed_at")
...
type agreement struct {
	...
	ALL       field.Asterisk
	ID        field.Uint64 // Primary key: Auto-incrementing unique identifier for each record
	UserID    field.Int32
	Content   field.String
	Version   field.String
	AgreedAt  field.Int64
...
func (a *agreement) updateTableName(table string) *agreement {
	...
	a.AgreedAt = field.NewInt64(table, "agreed_at")
...
func (a *agreement) fillFieldMap() {
	...
	a.fieldMap["agreed_at"] = a.AgreedAt
