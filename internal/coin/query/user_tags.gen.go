...
func newUserTag(db *gorm.DB, opts ...gen.DOOption) userTag {
	...
	_userTag.UID = field.NewInt32(tableName, "uid")
	_userTag.TagID = field.NewInt32(tableName, "tag_id")
	_userTag.TaggedTime = field.NewTime(tableName, "tagged_time")
...
func (u *userTag) updateTableName(table string) *userTag {
	...
	u.TagID = field.NewInt32(table, "tag_id")
	u.TaggedTime = field.NewTime(table, "tagged_time")
...
func (u *userTag) fillFieldMap() {
	...
	u.fieldMap["tagged_time"] = u.TaggedTime
}
